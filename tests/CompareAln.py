...
parser.add_argument('-v', '--verbose',
                    action='store_true', help='При наличии данного аргумента в stdout выводится процент одинаково выровненных колонок от обоих выравниваний и координаты блоков из идущих подряд одинаково выравненных колонок.')
...
def create_positions_list(seqs):
    ...
    return positions  # По идее, это список, содержащий элементы, которые тоже списки;
